...
class Iface(object):
    ...
    def bm_set_toeplitz_hash_key(self, cxt_id, calc_name, key):
        """
        Parameters:
         - cxt_id
         - calc_name
...
class Client(Iface):
    ...
    def bm_set_toeplitz_hash_key(self, cxt_id, calc_name, key):
        ...
        """
        self.send_bm_set_toeplitz_hash_key(cxt_id, calc_name, key)
        self.recv_bm_set_toeplitz_hash_key()

    def send_bm_set_toeplitz_hash_key(self, cxt_id, calc_name, key):
        self._oprot.writeMessageBegin('bm_set_toeplitz_hash_key', TMessageType.CALL, self._seqid)
        args = bm_set_toeplitz_hash_key_args()
        args.cxt_id = cxt_id
        args.calc_name = calc_name
        args.key = key
        args.write(self._oprot)
    ...
    def recv_bm_set_toeplitz_hash_key(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = bm_set_toeplitz_hash_key_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.ouch is not None:
            raise result.ouch
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["bm_set_toeplitz_hash_key"] = Processor.process_bm_set_toeplitz_hash_key
    ...
    def process_bm_set_toeplitz_hash_key(self, seqid, iprot, oprot):
        args = bm_set_toeplitz_hash_key_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = bm_set_toeplitz_hash_key_result()
        try:
            self._handler.bm_set_toeplitz_hash_key(args.cxt_id, args.calc_name, args.key)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except InvalidToeplitzHashOperation as ouch:
            msg_type = TMessageType.REPLY
            result.ouch = ouch
        except TApplicationException as ex:
            logging.exception('TApplication exception in handler')
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("bm_set_toeplitz_hash_key", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class bm_set_toeplitz_hash_key_args(object):
    """
    Attributes:
     - cxt_id
     - calc_name
    ...
    def __init__(self, cxt_id=None, calc_name=None, key=None,):
        self.cxt_id = cxt_id
        self.calc_name = calc_name
        self.key = key
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('bm_set_toeplitz_hash_key_args')
        if self.cxt_id is not None:
            oprot.writeFieldBegin('cxt_id', TType.I32, 1)
            oprot.writeI32(self.cxt_id)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(bm_set_toeplitz_hash_key_args)
bm_set_toeplitz_hash_key_args.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'cxt_id', None, None, ),  # 1
    (2, TType.STRING, 'calc_name', 'UTF8', None, ),  # 2
...
class bm_set_toeplitz_hash_key_result(object):
    """
    Attributes:
     - ouch
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.ouch = InvalidToeplitzHashOperation()
                    self.ouch.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('bm_set_toeplitz_hash_key_result')
        if self.ouch is not None:
            oprot.writeFieldBegin('ouch', TType.STRUCT, 1)
            self.ouch.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(bm_set_toeplitz_hash_key_result)
bm_set_toeplitz_hash_key_result.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'ouch', [InvalidToeplitzHashOperation, None], None, ),  # 1
)
